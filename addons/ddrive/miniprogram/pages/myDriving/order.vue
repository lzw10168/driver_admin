<template>
  <view class="index">
    ...
    <view class="center">
      <view class="orders" v-if="order.total > 0" v-for="(v, i) in order.data" :key="i" @tap="navigateTo('/pages/myDriving/drivingDetails?order_id=' + v.id)">
        <view class="top">
          <view class="input">
    ...
    <view class="bottom">
      ...
      <view class="item active" @tap="navigateTo('/pages/myDriving/order')">
        <text class="icon">&#xe616;</text>
        订单
      </view>
