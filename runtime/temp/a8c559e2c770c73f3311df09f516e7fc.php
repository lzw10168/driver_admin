<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:89:"/www/wwwroot/website.lovexy.life/public/../application/admin/view/card_verified/edit.html";i:1616820712;s:75:"/www/wwwroot/website.lovexy.life/application/admin/view/layout/default.html";i:1616820714;s:72:"/www/wwwroot/website.lovexy.life/application/admin/view/common/meta.html";i:1616820712;s:74:"/www/wwwroot/website.lovexy.life/application/admin/view/common/script.html";i:1616820712;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Card_brand'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-card_brand" class="form-control" name="row[card_brand]" type="text" value="<?php echo htmlentities($row['card_brand']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Number_plate'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-number_plate" class="form-control" name="row[number_plate]" type="text" value="<?php echo htmlentities($row['number_plate']); ?>">
        </div>
    </div>
    <div class="form-group">
