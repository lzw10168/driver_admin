<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:85:"/www/wwwroot/website.lovexy.life/public/../application/admin/view/user/user/edit.html";i:1616820714;s:75:"/www/wwwroot/website.lovexy.life/application/admin/view/layout/default.html";i:1616820714;s:72:"/www/wwwroot/website.lovexy.life/application/admin/view/common/meta.html";i:1616820712;s:74:"/www/wwwroot/website.lovexy.life/application/admin/view/common/script.html";i:1616820712;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label for="c-nickname" class="control-label col-xs-12 col-sm-2"><?php echo __('Money'); ?>:</label>
        <div class="col-xs-12 col-sm-4">
            <input id="c-money" data-rule="required" class="form-control" name="row[money]" type="text" value="<?php echo htmlentities($row['money']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="c-nickname" class="control-label col-xs-12 col-sm-2"><?php echo __('Platform_service_fee'); ?>:</label>
        <div class="col-xs-12 col-sm-4">
            <input id="c-platform_service_fee" data-rule="required" class="form-control" name="row[platform_service_fee]" type="text" value="<?php echo htmlentities($row['platform_service_fee']); ?>">
        </div>
    </div>
    <div class="form-group">
